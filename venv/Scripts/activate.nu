...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ASUS\Desktop\python-mysql-sqlalchemy\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ASUS\Desktop\python-mysql-sqlalchemy\venv\Scripts\deactivate.nu'
